...
app.layout = html.Div([
    ...
    html.H1(app.title,
            style={'textAlign': 'center', 'color': '#503D36',
                    'font-size': 26}),#Include style for title
    ...
    html.Div(id='plot-1', className='..........', style={.........}),
    html.Div(id='plot-2', className='..........', style={.........})], style = {'display' = 'flex'}),

    html.Div([#TASK 2.3: Add a division for output display
    html.Div(id='plot-3', className='..........', style={.........}),
    html.Div(id='plot-4', className='..........', style={.........})], style = {'display' = 'flex'})
])
